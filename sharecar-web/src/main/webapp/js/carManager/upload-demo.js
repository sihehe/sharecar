(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: path+'/AssessmentAction/summaryUpload',
            // runtimeOrder: 'flash',
        ...
        function addFile( file ) {
            var $li = $( '<li id="' + file.id + '">' +
                '<p class="title" style="z-index:10">' + file.name + '</p>' +
                '<p class="imgWrap"></p>'+
            ...
            //如果是服务端回显，则追加下载功能 start
            if(file.isServer){
                $li.find('p.imgWrap').click(function(){
                    downloadServerFile(file.id);
                });
            }
            //如果是服务端回显，则追加下载功能 end
        ...
        function updateStatus() {
            ...
            if ( state === 'ready' ) {
                ...
                if ( stats.uploadFailNum ) {
                    text = '已成功上传' + stats.successNum+ '个附件至XX附件，'+
                        stats.uploadFailNum + '个附件上传失败，<a class="retry" href="#">重新上传</a>失败图片或<a class="ignore" href="#">忽略</a>'
                }
        ...
        uploader.on( 'uploadError', function(file,reason) {
            console.log(file+"====reason:"+reason);
        });
