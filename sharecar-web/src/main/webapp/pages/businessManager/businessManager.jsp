...
<div class="col-sm-12" style="padding: 0 20px">
    <div class="searchfrom row">
        <div class="form-group form-group-md">
            ...
            <label class="col-sm-1 control-label" for="queryType">类型:</label>

            <div class="col-sm-3">
                <select class="form-control m-b" name="account" id="queryType">
...
<!-- Peity -->
<script src="${pageContext.request.contextPath}/js/businessManager/businessManager.js"></script>
